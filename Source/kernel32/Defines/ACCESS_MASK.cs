...
namespace Win32Bindings.kernel32.Defines
{
    ...
    ///     <para>
    ///         The values in this enum are provided for simpler use of the acces mask. Just OR
    ///         them together to your needs.
    ///     </para>
    /// </remarks>
    [CLSCompliant(false)]
    [Flags]
    public enum ACCESS_MASK : uint
    {
        ...
        /// <summary>
        ///     Combines <see cref="DELETE" />, <see cref="READ_CONTROL" />, <see cref="WRITE_DAC" />, <see cref="WRITE_OWNER" />
        ///     and <see cref="SYNCHRONIZE" /> access.
        /// </summary>
