...
namespace Win32Bindings.kernel32.Defines
{
    /// <summary>
    ...
    ///     <see cref="GENERIC">GENERIC.*</see> or
    ///     <see cref="ACCESS_MASK">
    ///         ACCESS_MASK.GENERIC_*
    ///     </see>
    ///     . See <see cref="ACCESS_MASK" /> for more information.
    /// </summary>
    [CLSCompliant(false)]
    [Flags]
    ...
    {
        /// <summary>
        ///     Collects the specific and standard access rights, that are set for
        ///     <see cref="GENERIC.READ">GENERIC_READ</see>.
        /// </summary>
        ...
        /// <summary>
        ///     Collects the specific and standard access rights, that are set for
        ///     <see cref="GENERIC.READ">GENERIC_WRITE</see>.
        /// </summary>
        ...
        /// <summary>
        ///     Collects the specific and standard access rights, that are set for
        ///     <see cref="GENERIC.EXECUTE">GENERIC_EXECUTE</see>.
        /// </summary>
