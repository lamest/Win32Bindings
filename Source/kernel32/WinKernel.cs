...
namespace Win32Bindings.kernel32
{
    ...
    public static class WinKernel
    {
        ...
        /// </summary>
        /// <remarks>
        ///     This is for convenience only, you should use <see cref="Marshal.GetLastWin32Error" /> in conjunction with
        ///     <see cref="DllImportAttribute.SetLastError" /> set <b>true</b>.
        /// </remarks>
        ...
        /// <summary>
        ///     Retrieves the current value of the performance counter, which is a high resolution (&lt;1µs) time stamp that can be
        ...
        /// <returns>
        ///     <b>true</b> if successful; otherwise, <b>false</b>. Use <see cref="GetLastError" /> to get extended error
        ///     information.
        /// </returns>
        [DllImport(DLLName)]
        ...
        /// <returns>
        ///     <b>true</b> the installed hardware supports a high-resolution performance counter; otherwise, <b>false</b>.
