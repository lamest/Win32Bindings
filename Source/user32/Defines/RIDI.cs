...
namespace Win32Bindings.user32.Defines
{
    ...
    public enum RIDI : uint
    {
        /// <summary>
        ///     <para>
        ///         <b>pData</b> parameter of <see cref="O:Win32.RawInput.RawInput.GetRawInputDeviceInfo" /> points to a string
        ///         that contains the device name.
        ///     </para>
        ///     <para>
        ///         For this <b>uiCommand</b> only, the value in <b>pcbSize</b> of
        ///         <see cref="O:Win32.RawInput.RawInput.GetRawInputDeviceInfo" />is the character count (not the byte count).
        ///     </para>
        /// </summary>
