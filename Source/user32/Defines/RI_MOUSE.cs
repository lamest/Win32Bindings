...
namespace Win32Bindings.user32.Defines
{
    ...
    public enum RI_MOUSE : ushort
    {
        ...
        /// <summary>
        ///     Raw input comes from a mouse wheel. The wheel delta is stored in <see cref="RawHidReading.Win32.user32.Structs.RAWMOUSE.usButtonData" />.
        /// </summary>
        WHEEL = 0x0400,

        /// <summary>
        ///     Raw input comes from a horizontal mouse wheel. The wheel delta is stored in
        ///     <see cref="RawHidReading.Win32.user32.Structs.RAWMOUSE.usButtonData" />.
        /// </summary>
