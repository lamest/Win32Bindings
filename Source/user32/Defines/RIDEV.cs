...
namespace Win32Bindings.user32.Defines
{
    ...
    ///     <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE.usUsagePage" /> and <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE.usUsage" />.
    /// </summary>
    [CLSCompliant(false)]
    [Flags]
    public enum RIDEV : uint
    {
        ...
        ///     <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE.usUsagePage" />. Note that <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE.usUsage" />
        ...
        /// <summary>
        ///     If set, this prevents any devices specified by <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE.usUsagePage" />
        ///     or <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE.usUsage" /> from generating legacy messages. This is only
        ///     for the mouse and keyboard. See <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE">Remarks</see>.
        /// </summary>
        NOLEGACY = 0x00000030,

        /// <summary>
        ///     If set, this enables the caller to receive the input even when the caller is not in the
        ///     foreground. Note that <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE.hwndTarget" /> must be specified.
        /// </summary>
        ...
        ///     <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE.hwndTarget" /> is <b>null</b> (IntPtr.Zero).
        /// </summary>
        ...
        ///     <see cref="RawHidReading.Win32.WinMessage.WM.INPUT_DEVICE_CHANGE">WM_INPUT_DEVICE_CHANGE</see>
        ///     notifications for device arrival and device removal. This works only when <see cref="INPUTSINK" />
        ///     is also set (and of course <see cref="RawHidReading.Win32.user32.Structs.RAWINPUTDEVICE.hwndTarget" /> must be specified).
        /// </summary>
        /// <remarks><b>Windows XP:</b> This flag is not supported until Windows Vista</remarks>
