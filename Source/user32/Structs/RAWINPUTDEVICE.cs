...
namespace Win32Bindings.user32.Structs
{
    ...
    /// <remarks>
    ///     <para>
    ///         If <see cref="RIDEV.NOLEGACY">RIDEV_NOLEGACY</see> is set for a mouse or a
    ///         keyboard, the system does not
    ///         generate any legacy message for that device for the application. For example, if the mouse TLC is set with
    ///         <see cref="RIDEV.NOLEGACY">RIDEV_NOLEGACY</see>,
    ///         <see cref="RawHidReading.Win32.WinMessage.WM.LBUTTONDOWN">WM_LBUTTONDOWN</see> and
    ///         related legacy mouse messages are not generated. Likewise, if the keyboard TLC is set with
    ///         <see cref="RIDEV.NOLEGACY">RIDEV_NOLEGACY</see>,
    ///         <see cref="RawHidReading.Win32.WinMessage.WM.KEYDOWN">WM_KEYDOWN</see> and related
    ///         legacy keyboard messages are not generated.
    ///     </para>
    ///     <para>
    ///         If <see cref="RIDEV.REMOVE">RIDEV_REMOVE</see> is set and the
    ///         <see cref="hwndTarget" /> member is not set
