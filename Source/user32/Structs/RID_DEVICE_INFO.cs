...
namespace Win32Bindings.user32.Structs
{
    ...
    public struct RID_DEVICE_INFO
    {
        ...
        /// </summary>
        [FieldOffset(4)] public RIM_TYPE dwType;

        /// <summary>
        ///     If <see cref="dwType" /> is <see cref="RIM_TYPE.MOUSE" />, this is the
        ///     <see cref="RID_DEVICE_INFO_MOUSE" />
        ///     structure that defines the mouse.
        /// </summary>
        [FieldOffset(8)] public RID_DEVICE_INFO_MOUSE mouse;

        /// <summary>
        ///     If <see cref="dwType" /> is <see cref="RIM_TYPE.KEYBOARD" />, this is the
        ///     <see cref="RID_DEVICE_INFO_KEYBOARD" />
        ///     structure that defines the keyboard.
        /// </summary>
        [FieldOffset(8)] public RID_DEVICE_INFO_KEYBOARD keyboard;

        /// <summary>
        ///     If <see cref="dwType" /> is <see cref="RIM_TYPE.HID" />, this is the
        ///     <see cref="RID_DEVICE_INFO_HID" />
