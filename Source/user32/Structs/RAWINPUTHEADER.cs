...
namespace Win32Bindings.user32.Structs
{
    ...
    /// </summary>
    /// <remarks>
    ///     To get more information on the device, use <see cref="hDevice" /> in a call to
    ...
    public struct RAWINPUTHEADER
    {
        ...
        /// <summary>
        ///     The value passed in the <b>wParam</b> parameter of the <see cref="RawHidReading.Win32.WinMessage.WM.INPUT">WM_INPUT</see> message.
        /// </summary>
