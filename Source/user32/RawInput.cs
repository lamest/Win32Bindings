...
namespace Win32Bindings.user32
{
    ...
    public class RawInput
    {
        ...
        private const string GetRawInputDeviceInfoW = "GetRawInputDeviceInfoW";
        ...
        [DllImport(DLLName)]
        public static extern LRESULT DefRawInputProc([In] HANDLE[] paRawInput, int nInput, uint cbSizeHeader);
        ...
        /// <remarks>
        ///     <para>
        ///         Using <see cref="GetRawInputBuffer" />, the raw input data is buffered in the array of
        ///         <see cref="RAWINPUT" /> structures. For an unbuffered read, listen to
        ///         <see cref="RawHidReading.Win32.WinMessage.WM.INPUT">WM_INPUT</see> and use the message details to read the raw input data.
        ///     </para>
        ///     <para>
        ///         The <see cref="NEXTRAWINPUTBLOCK" /> methode allows an application to traverse an array
        ///         of <see cref="RAWINPUT" /> structures.
        ///     </para>
        ///     <para>
        ///         <b>Note:</b> To get the correct size of the raw input buffer, do not use
        ///         <paramref name="pcbSize" />, use <paramref name="pcbSize" />*8 instead.
        ///     </para>
        /// </remarks>
        /// <param name="pData">
        ///     A pointer to a buffer of <see cref="RAWINPUT" /> structures that contain the
        ///     raw input data. If <b>null</b> (IntPtr.Zero), the minimum required buffer, in bytes, is returned
        ///     in <paramref name="pcbSize" />.
        /// </param>
        /// <param name="pcbSize">The size, in bytes, of a <see cref="RAWINPUT" /> structure.</param>
        /// <param name="cbSizeHeader">The size, in bytes, of the <see cref="RAWINPUTHEADER" /> structure.</param>
        /// <returns>
        ///     <para>
        ///         If <paramref name="pData" /> is <b>null</b> and the function is successful, the return value
        ///         is zero (0). If <paramref name="pData" /> is not <b>null</b> and the function is successful, the return
        ///         value is the number of <see cref="RAWINPUT" /> structures written to <paramref name="pData" />.
        ///     </para>
        ///     <para>
        ///         If an error occurs, the return value is <see cref="uint.MaxValue" /> (-1). Call
        ///         <see cref="WinKernel.GetLastError" /> for the error code.
        ///     </para>
        /// </returns>
        [DllImport(DLLName)]
        public static extern uint GetRawInputBuffer(HANDLE pData, ref uint pcbSize, uint cbSizeHeader);
        ...
        /// <param name="pData">
        ///     A pointer to the data that comes from the <see cref="RAWINPUT" /> structure.
        ///     This depends on the value of <paramref name="uiCommand" />. If pData is <b>null</b> (IntPtr.Zero),
        ///     the required size of the buffer is returned in <paramref name="pcbSize" />.
        /// </param>
        /// <param name="pcbSize">The size, in bytes, of the data in <paramref name="pData" />.</param>
        /// <param name="cbSizeHeader">The size, in bytes, of the <see cref="RAWINPUTHEADER" /> structure.</param>
        /// <returns>
        ///     <para>
        ///         If <paramref name="pData" /> is <b>null</b> (IntPtr.Zero) and the function is successful,
        ...
        /// </returns>
        [DllImport(DLLName)]
        public static extern uint GetRawInputData(HRAWINPUT hRawInput, RID uiCommand, HANDLE pData, ref uint pcbSize, uint cbSizeHeader);
        ...
        /// </summary>
        /// <param name="hDevice">
        ///     A handle to the raw input device. This comes from the <b>lParam</b> of the
        ///     <see cref="WinMessage.WM.INPUT">WM_INPUT</see> message, from the <see cref="RAWINPUTHEADER.hDevice">hDevice</see>
        ///     member of <see cref="RAWINPUTHEADER" />, or from <see cref="GetRawInputDeviceList" />. It can also be
        ///     <b>null</b> (IntPtr.Zero) if an application inserts input data, for example, by using <b>SendInput</b>.
        /// </param>
        /// <param name="uiCommand">
        ///     Specifies what data will be returned in <paramref name="pData" />. See
        ///     <see cref="RIDI" /> for more information.
        /// </param>
        /// <param name="pData">
        ///     A pointer to a buffer that contains the information specified by <paramref name="uiCommand" />.
        ///     If <paramref name="uiCommand" /> is <see cref="RIDI.DEVICEINFO" />, set the
        ///     <see cref="RID_DEVICE_INFO.cbSize">cbSize</see>
        ///     member of <see cref="RID_DEVICE_INFO" /> to <b>sizeof(RID_DEVICE_INFO)</b> before calling
        ///     <see cref="O:Win32.RawInput.RawInput.GetRawInputDeviceInfo" />.
        /// </param>
        /// <param name="pcbSize">
        ///     The size, in bytes or characters (if <paramref name="uiCommand" /> is <see cref="RIDI.DEVICENAME" />),
        ///     of the data in <paramref name="pData" />.
        /// </param>
        /// <returns>
        ///     <para>
        ///         If successful, this function returns a non-negative number indicating the number of bytes or characters
        ///         (if <paramref name="uiCommand" /> is <see cref="RIDI.DEVICENAME" />) copied to <paramref name="pData" />.
        ///     </para>
        ///     <para>
        ///         If <paramref name="pData" /> is not large enough for the data, the function returns
        ...
        ///         required for the <paramref name="pData" /> buffer.
        ///     </para>
        ...
        /// <remarks>
        ///     <para>
        ///         The devices returned from this function are the mouse, the keyboard, and other Human Interface Device (HID)
        ///         devices.
        ///     </para>
        ///     <para>
        ///         To get more detailed information about the attached devices, call
        ///         <see cref="O:Win32.RawInput.RawInput.GetRawInputDeviceInfo" /> using
        ///         the <see cref="RAWINPUTDEVICELIST.hDevice">hDevice</see> from <see cref="RAWINPUTDEVICELIST" />.
        ///     </para>
        /// </remarks>
        /// <param name="pRawInputDeviceList">
        ///     An array of <see cref="RAWINPUTDEVICELIST" /> structures for the devices attached to
        ///     the system. If <b>null</b>, the number of devices are returned in <paramref name="puiNumDevices" />.
        /// </param>
        /// <param name="puiNumDevices">
        ///     If <paramref name="pRawInputDeviceList" /> is <b>null</b>, the function
        ...
        ///     <see cref="ERROR.INSUFFICIENT_BUFFER" />.
        /// </param>
        /// <param name="cbSize">The size of a <see cref="RAWINPUTDEVICELIST" /> structure, in bytes.</param>
        /// <returns>
        ///     <para>
        ///         If the function is successful, the return value is the number of devices stored in the buffer pointed
        ///         to by <paramref name="pRawInputDeviceList" />.
        ///     </para>
        ///     <para>
        ///         On any other error, the function returns <see cref="uint.MaxValue" /> (-1) and
        ///         <see cref="WinKernel.GetLastError" /> returns the error indication.
        ///     </para>
        /// </returns>
        [DllImport(DLLName)]
        public static extern uint GetRawInputDeviceList([Out] [MarshalAs(UnmanagedType.LPArray)]
            RAWINPUTDEVICELIST[] pRawInputDeviceList, ref uint puiNumDevices, uint cbSize);
        ...
        /// <param name="puiNumDevices">
        ///     The number of <see cref="RAWINPUTDEVICE" /> structures in
        ///     <paramref name="pRawInputDevices" />.
        /// </param>
        ...
        ///     </para>
        ///     <para>
        ///         If the <paramref name="pRawInputDevices" /> buffer is too small or <b>null</b> (IntPtr.Zero), the function sets
        ///         the last error as <see cref="ERROR.INSUFFICIENT_BUFFER" />, returns <see cref="uint.MaxValue" /> (-1), and sets
        ///         <paramref name="puiNumDevices" /> to the required number of devices. If the function fails for any other
        ///         reason, it
        ///         returns <see cref="uint.MaxValue" /> (-1). For more details, call <see cref="WinKernel.GetLastError" />.
        ///     </para>
        /// </returns>
        [DllImport(DLLName)]
        public static extern uint GetRegisteredRawInputDevices([Out] [MarshalAs(UnmanagedType.LPArray)]
            RAWINPUTDEVICE[] pRawInputDevices, ref uint puiNumDevices, uint cbSize);
        ...
        /// <remarks>
        ///     <para>
        ///         To receive <see cref="RawHidReading.Win32.WinMessage.WM.INPUT">WM_INPUT</see> messages, an application must first register the raw
        ///         input
        ///         devices using <see cref="RegisterRawInputDevices" />. By default, an application does not receive raw input.
        ///     </para>
        ///     <para>
        ///         To receive <see cref="RawHidReading.Win32.WinMessage.WM.INPUT_DEVICE_CHANGE">WM_INPUT_DEVICE_CHANGE</see> messages, an application
        ///         must
        ...
        ///         <see cref="RawHidReading.Win32.WinMessage.WM.INPUT_DEVICE_CHANGE">WM_INPUT_DEVICE_CHANGE</see> notifications for raw input device
        ///         arrival and removal.
        ///     </para>
        ///     <para>
        ///         If a <see cref="RAWINPUTDEVICE" /> structure has the <see cref="RIDEV.REMOVE" /> flag set and the
        ...
        ///     An array of <see cref="RAWINPUTDEVICE" /> structures that represent the
        ///     devices that supply the raw input.
        /// </param>
        /// <param name="uiNumDevices">
        ///     The number of <see cref="RAWINPUTDEVICE" /> structures pointed to by
        ///     <paramref name="pRawInputDevices" />.
        /// </param>
        /// <param name="cbSize">The size, in bytes, of a <see cref="RAWINPUTDEVICE" /> structure.</param>
        /// <returns>
        ///     <b>true</b> if the function succeeds; otherwise, <b>false</b>. If the function fails, call
        ///     <see cref="WinKernel.GetLastError" /> for more information.
        /// </returns>
        [DllImport(DLLName)]
        ...
        private static HANDLE RAWINPUT_ALIGN(HANDLE x)
        {
            if (IntPtr.Size == sizeof(int))
            {
                var s = (uint) IntPtr.Size - 1;
                return (IntPtr) (((uint) x + s) & ~s);
            }
            else
            {
                var s = (ulong) IntPtr.Size - 1;
        ...
        /// <summary>
        ///     Use this methode to get the input code of a <see cref="RawHidReading.Win32.WinMessage.WM.INPUT">WM_INPUT</see> message from wParam.
        /// </summary>
        /// <param name="wParam">The <b>wParam</b> of a <see cref="RawHidReading.Win32.WinMessage.WM.INPUT">WM_INPUT</see> message.</param>
        /// <returns>The input code of a <see cref="RawHidReading.Win32.WinMessage.WM.INPUT">WM_INPUT</see> message as <see cref="RIM" />.</returns>
        public static RIM GET_RAWINPUT_CODE_WPARAM(WPARAM wParam)
        {
            return (RIM) ((int) wParam & 0xff);
        }

        /// <summary>
        ///     Use this methode to get the input code of a
        ///     <see cref="RawHidReading.Win32.WinMessage.WM.INPUT_DEVICE_CHANGE">WM_INPUT_DEVICE_CHANGE</see> message from wParam.
        /// </summary>
        /// <param name="wParam">
        ///     The <b>wParam</b> of a <see cref="RawHidReading.Win32.WinMessage.WM.INPUT_DEVICE_CHANGE">WM_INPUT_DEVICE_CHANGE</see>
        ///     message.
        /// </param>
        /// <returns>
        ///     The input code of a <see cref="RawHidReading.Win32.WinMessage.WM.INPUT_DEVICE_CHANGE">WM_INPUT_DEVICE_CHANGE</see> message as
        ///     <see cref="GIDC" />.
        /// </returns>
        public static GIDC GET_RAWINPUT_DEVICE_CHANGE_CODE_WPARAM(WPARAM wParam)
        {
            return (GIDC) ((int) wParam & 0xff);
        }
        ...
        [DllImport(DLLName, EntryPoint = GetRawInputDeviceInfoW, CharSet = CharSet.Unicode, ExactSpelling = true)]
        private static extern uint GetRawInputDeviceInfo(HANDLE hDevice, RIDI uiCommand, StringBuilder pData, ref uint pcbSize);
        ...
        private static extern bool RegisterRawInputDevice([In] ref RAWINPUTDEVICE pRawInputDevice, uint uiNumDevices, uint cbSize);
        ...
        /// <param name="hDevice">
        ///     A handle to the raw input device. This comes from the <b>lParam</b> of the
        ///     <see cref="RawHidReading.Win32.WinMessage.WM.INPUT">WM_INPUT</see> message, from the <see cref="RAWINPUTHEADER.hDevice">hDevice</see>
        ///     member of <see cref="RAWINPUTHEADER" />, or from <see cref="GetRawInputDeviceList" />. It can also be
        ///     <b>null</b> (IntPtr.Zero) if an application inserts input data, for example, by using <b>SendInput</b>.
        /// </param>
        ...
        {
            uint size = 0;
            var err = GetRawInputDeviceInfo(hDevice, RIDI.DEVICENAME, IntPtr.Zero, ref size);
            ...
            var tmp = new StringBuilder((int) size);
        ...
        {
            var size = (uint) Marshal.SizeOf(typeof(RID_DEVICE_INFO));

            var ret = new RID_DEVICE_INFO();
            ret.cbSize = size;

            var err = GetRawInputDeviceInfo(hDevice, RIDI.DEVICEINFO, ref ret, ref size);
        ...
        {
            uint size = 0;
            var err = GetRawInputDeviceInfo(hDevice, RIDI.PREPARSEDDATA, IntPtr.Zero, ref size);
        ...
        public static List<Tuple<HANDLE, RIM_TYPE>> EnumerateDevices()
        {
            ...
            for (var i = 0; i < deviceCount; i++) ret.Add(new Tuple<LRESULT, RIM_TYPE>(tmp[i].hDevice, tmp[i].dwType));
        ...
        ///     A <see cref="RAWINPUTDEVICE" /> structure that represent the
        ///     devices that supply the raw input.
        /// </param>
        /// <returns>
        ///     <b>true</b> if the function succeeds; otherwise, <b>false</b>. If the function fails, call
        ...
        ///         <paramref name="usagePage" /> and <paramref name="usage" /> arguments. By default, an application does not
        ///         receive
        ///         <see cref="RawHidReading.Win32.WinMessage.WM.INPUT_DEVICE_CHANGE">WM_INPUT_DEVICE_CHANGE</see> notifications for raw input device
        ///         arrival and removal.
        ///     </para>
        ...
        {
            var pRawInputDevice = new RAWINPUTDEVICE();
        ...
        ///     </para>
        ///     <para>
        ///         If the <see cref="RIDEV.REMOVE" /> flag set and <paramref name="hwndTarget" /> is not set to <b>null</b>
        ///         (IntPtr.Zero),
        ///         then parameter validation will fail.
        ///     </para>
        /// </remarks>
        ...
        ///     The handle of the window, which shall receive the <see cref="RawHidReading.Win32.WinMessage.WM.INPUT">WM_INPUT</see>
        ///     and <see cref="RawHidReading.Win32.WinMessage.WM.INPUT_DEVICE_CHANGE">WM_INPUT_DEVICE_CHANGE</see> messages.
        /// </param>
        /// <returns>
        ///     <b>true</b> if the function succeeds; otherwise, <b>false</b>. If the function fails, call
        ///     <see cref="WinKernel.GetLastError" /> for more information.
        ...
        /// </param>
        /// <param name="size">
        ///     Size of the <see cref="RAWINPUT" /> structure. Can be queried using
        ///     <see cref="GetRawInputDataHeader" />; the size is stored in <see cref="RAWINPUTHEADER.dwSize" />.
        /// </param>
        /// <param name="offset">
        ///     An offset to the start of the data, to be returned, in the resulting data of a
        ///     <see cref="GetRawInputData" /> call, without the <see cref="RAWINPUTHEADER" />, which is omitted anyway.
        /// </param>
        /// <returns>The raw input header as specified when called.</returns>
        public static T GetRawInputData<T>(HRAWINPUT hRawInput, int size, int offset = 0) where T : struct
        {
            ...
            var dwSize = (uint) size;

            try
            {
                var err = GetRawInputData(hRawInput, RID.INPUT, buffer, ref dwSize, RAWINPUTHEADER.SIZE);
